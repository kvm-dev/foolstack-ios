...
@MainActor
protocol TagsCollectionLayoutDelegate: AnyObject {
...
class TagsCollectionLayout: UICollectionViewLayout {
    weak var delegate: TagsCollectionLayoutDelegate?
        
    // Total height of the content. Will be used to configure the scrollview content
    var layoutHeight: CGFloat = 0.0
    var layoutWidthIterator: CGFloat = 0 // Used to calculate the X position of the current item
